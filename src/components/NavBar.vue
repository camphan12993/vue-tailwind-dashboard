<template>
  <header class="z-10 py-4 h-16 bg-white border-b dark:bg-gray-800">
    <div class="flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
      <!-- Mobile hamburger -->
      <button @click="toggleSidebar()"
        class="p-1 mr-5 -ml-1 rounded-md hover:opacity-80 focus:outline-none focus:shadow-outline-purple"
        aria-label="Menu">
...
export default defineComponent({
  ...
  setup() {
    ...
    return { toggleSidebar, isProfileMenuOpen, logout: () => store.dispatch(actionTypes.LOGOUT) };
  }
});
</script>
